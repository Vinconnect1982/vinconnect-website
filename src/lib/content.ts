...
export const SECURITY: ServicePage[] = [
  ...
  },
  {
    ...
    image: "/media/projects/pakenham-commercial-factory.webp",
...
export const PROJECTS: Project[] = [
  { slug: "cranbourne-cricket-club", place: "Cranbourne", areaSlug: "cranbourne", title: "Cranbourne Cricket Club", summary: "Starlink and Ubiquiti Wi-Fi replaced the club’s Telstra 4G connection, with FrogBox streaming and integration into the existing data rack.", image: "/media/projects/cranbourne-cricket-club.webp" },
  { slug: "somerville-tripod-install", place: "Somerville", areaSlug: "somerville", title: "Somerville Tripod Installation", summary: "An Astrogear tripod mount provided a secure Starlink installation without roof penetrations.", image: "/media/projects/somerville-tripod-install.webp" },
  { slug: "nyora-new-home-cctv", place: "Nyora", areaSlug: "nyora", title: "Nyora New Home & CCTV", summary: "Starlink was installed at a newly occupied home using a mount without roof penetrations and connected to the existing CCTV.", image: "/media/projects/nyora-new-home-cctv.webp" },
  { slug: "pakenham-commercial-factory", place: "Pakenham", areaSlug: "pakenham", title: "Pakenham Commercial Factory", summary: "A factory rooftop Starlink installation, from mounting and cable runs through commissioning.", image: "/media/projects/pakenham-commercial-factory.webp" },
  { slug: "pearcedale-five-acre-property", place: "Pearcedale", areaSlug: "pearcedale", title: "Pearcedale Five-Acre Property", summary: "Starlink and extended Wi-Fi connected the home, shed and workshop on a five-acre property.", image: "/media/projects/pearcedale-five-acre-property.webp" },
  { slug: "safety-beach-concealed-install", place: "Safety Beach", areaSlug: "safety-beach", title: "Safety Beach Concealed Install", summary: "An Astrogear tripod installation on a double-storey, flat-roof home with concealed gutters.", image: "/media/projects/safety-beach-concealed-install.webp" },
  { slug: "red-hill-multi-level-home", place: "Red Hill", areaSlug: "red-hill", title: "Red Hill Multi-Level Home", summary: "Starlink replaced unreliable fixed wireless at a large multi-level home overlooking the bay.", image: "/media/projects/red-hill-multi-level-home.webp" },
  { slug: "botanic-ridge-double-storey", place: "Botanic Ridge", areaSlug: "botanic-ridge", title: "Botanic Ridge Double Storey", summary: "A double-storey fascia installation with Starlink connected to the customer’s existing UPS.", image: "/media/projects/botanic-ridge-double-storey.webp" },
  { slug: "bittern-copper-nbn-upgrade", place: "Bittern", areaSlug: "bittern", title: "Bittern Copper NBN Upgrade", summary: "A professionally roof-mounted Starlink installation replaced an ageing copper NBN service.", image: "/media/projects/bittern-copper-nbn-upgrade.webp" },
  { slug: "sorrento-coastal-home", place: "Sorrento", areaSlug: "sorrento", title: "Sorrento Coastal Home", summary: "A mounted Starlink system replaced an unreliable copper connection at an architectural coastal home.", image: "/media/projects/sorrento-coastal-home.webp" },
  { slug: "caldermeade-rural-property", place: "Caldermeade", areaSlug: "caldermeade", title: "Caldermeade Rural Property", summary: "Starlink installed after the customer experienced slow fixed wireless and frequent dropouts.", image: "/media/projects/caldermeade-rural-property.webp" },
  { slug: "clyde-new-estate-home", place: "Clyde", areaSlug: "clyde", title: "Clyde New Estate Home", summary: "A new home was connected where NBN and OptiComm infrastructure was not yet available.", image: "/media/projects/clyde-new-estate-home.webp" },
  { slug: "lyndhurst-rental-home", place: "Lyndhurst", areaSlug: "lyndhurst", title: "Lyndhurst Rental Home", summary: "A rental-friendly mounting approach and cable entry through an existing Hills Home Hub cabinet.", image: "/media/projects/lyndhurst-rental-home.webp" },
  { slug: "nyora-fixed-wireless-upgrade", place: "Nyora", areaSlug: "nyora", title: "Nyora Fixed Wireless Upgrade", summary: "A roof-mounted Starlink system replaced an unreliable fixed-wireless connection at a rural home.", image: "/media/projects/nyora-fixed-wireless-upgrade.webp" },
  { slug: "tooradin-rural-install", place: "Tooradin", areaSlug: "tooradin", title: "Tooradin Rural Installation", summary: "Roof-mounted Starlink brought internet to a large rural property.", image: "/media/projects/tooradin-rural-install.webp" },
  { slug: "cranbourne-east-upgrade", place: "Cranbourne East", areaSlug: "cranbourne-east", title: "Cranbourne East Upgrade", summary: "A mounted Starlink system addressed intermittent dropouts and a bottleneck in the home’s previous connection.", image: "/media/projects/cranbourne-east-upgrade.webp" },
  { slug: "somerville-starlink-install", place: "Somerville", areaSlug: "somerville", title: "Somerville Starlink Installation", summary: "A completed Starlink installation in Somerville.", image: "/media/projects/somerville-starlink-install.webp" },
  { slug: "cranbourne-west-roof-mount", place: "Cranbourne West", areaSlug: "cranbourne-west", title: "Cranbourne West Roof Mount", summary: "A double-storey installation using an Astrogear tripod roof mount without roof penetrations.", image: "/media/projects/cranbourne-west-roof-mount.webp" },
];
