...
export const PROJECTS: Project[] = [
  ...
  { slug: "nyora-fixed-wireless-upgrade", place: "Nyora", areaSlug: "nyora", title: "Nyora Fixed Wireless Upgrade", summary: "A roof-mounted Starlink system replaced an unreliable fixed-wireless connection at a rural home.", image: "/media/projects/nyora-fixed-wireless-upgrade-hero-v6.webp", imageAlt: "Roof-mounted Starlink on the Nyora metal roof." },
