...
export const REGIONS: Region[] = [
  {
    ...
    image: "/scenes-new/casey-estates.jpg",
    lat: -38.11,
    lng: 145.29,
    zoom: 11,
  },
  {
    ...
    image: "/scenes-new/cardinia-paddocks.jpg",
    lat: -38.1,
    lng: 145.52,
    zoom: 10,
  },
  {
    ...
    short: "Peninsula",
    blurb: "Somerville to Sorrento. Coastal homes, tripod mounts, concealed gutters and unreliable copper upgrades.",
  ...
  },
  {
    ...
    image: "/scenes-new/bass-coast-bay.jpg",
    lat: -38.48,
    lng: 145.45,
    zoom: 9,
  },
  {
    ...
    blurb: "Nyora, Poowong, Korumburra, Leongatha and the hills beyond. Fixed-wireless pain and horse country.",
  ...
  },
  {
    ...
    blurb: "Warragul, Drouin, Traralgon and the valley towns. Shows, farms and longer travel that we quote up front.",
  ...
  },
  {
    ...
    short: "Inner SE",
    blurb: "Glen Waverley, Berwick, Narre Warren and Dandenong when the job is a clean Starlink, cabinet or camera install.",
    image: "/scenes-new/inner-se-street.jpg",
    lat: -37.99,
    lng: 145.25,
    zoom: 11,
  },
...
export const AREAS: Area[] = [
  ...
  { slug: "cranbourne-west", name: "Cranbourne West", region: "casey-south-east", postcode: "3977", lat: -38.106, lng: 145.255, blurb: "Roof and tripod Starlink installs without unnecessary penetrations on newer double-storey homes.", focus: "Non-penetrating mounts and clean internal routing.", nearby: ["cranbourne", "lyndhurst", "cranbourne-north"] },
  { slug: "cranbourne-north", name: "Cranbourne North", region: "casey-south-east", postcode: "3977", lat: -38.083, lng: 145.279, blurb: "Family homes north of the Cranbourne centre needing reliable Wi-Fi and a considered dish position.", focus: "Sky view, mesh placement and existing NBN handover.", nearby: ["cranbourne", "lyndhurst", "cranbourne-west"] },
  ...
  { slug: "poowong", name: "Poowong", region: "south-gippsland", postcode: "3988", lat: -38.344, lng: 145.758, blurb: "Hills, dairy and horse properties. A wireless link across a gully is a survey, not a catalogue kit.", focus: "Line-of-sight links and farm Wi-Fi.", nearby: ["nyora", "korumburra", "leongatha"] },
  ...
  { slug: "foster", name: "Foster", region: "south-gippsland", postcode: "3960", lat: -38.653, lng: 146.201, blurb: "Further down the South Gippsland highway. Quoted travel, honest about when a job is a day trip.", focus: "Rural homes and coastal-fringe properties.", nearby: ["meeniyan", "leongatha"] },
  { slug: "meeniyan", name: "Meeniyan", region: "south-gippsland", postcode: "3956", lat: -38.578, lng: 146.014, blurb: "Small town, large surrounding properties. Typical of the work we actually like doing.", focus: "Farm connectivity and tidy home installs.", nearby: ["leongatha", "foster", "korumburra"] },
  ...
  { slug: "morwell", name: "Morwell", region: "west-gippsland-latrobe", postcode: "3840", lat: -38.234, lng: 146.395, blurb: "Valley town with industrial and residential edges. Cabinets and cameras sit beside Starlink jobs.", focus: "CCTV, data and Starlink labour.", nearby: ["traralgon", "moe", "mirboo-north"] },
  ...
  { slug: "narre-warren", name: "Narre Warren", region: "inner-south-east", postcode: "3805", lat: -38.028, lng: 145.309, blurb: "Established south-east suburb. Typical four-camera homes and Starlink where the copper is tired.", focus: "Home Watch kits and standard Starlink labour.", nearby: ["berwick", "hallam", "cranbourne-north"] },
...
export function areaFaqs(area: Area) {
  return [
    ...
    },
    {
      ...
      a: `${area.focus} Labour is quoted separately from Starlink hardware and the monthly subscription, which stay on your account. Use the estimator for a starting range, then photos or a property plan before a written total.`,
    },
    {
