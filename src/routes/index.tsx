    ...
    <SiteShell>
      ...
      <section className="relative overflow-hidden border-y border-line">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6">
          ...
          <h2 className="mt-3 max-w-xl font-display text-3xl sm:text-5xl">Starlink ready from day one.</h2>
          <p className="mt-4 max-w-xl text-fg/90">
            The builder offer your buyers ask for. The home is prepared during the build, so they can activate on move-in day.
          </p>
          <Button asChild className="mt-7">
            <AppLink to="/vinready">Get the builder pack</AppLink>
          </Button>
        </div>
      </section>
