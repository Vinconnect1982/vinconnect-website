    ...
    <SiteShell>
      ...
      <article>
        <div className="relative overflow-hidden">
          <img src={project.image} alt={`${project.title} in ${project.place}. Reconstructed from the original VINCONNECT job photograph.`} className="absolute inset-0 h-full min-h-[22rem] w-full bg-ink object-contain object-center sm:min-h-[28rem]" />
